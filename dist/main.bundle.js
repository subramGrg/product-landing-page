...
var _ProductOptions = __webpack_require__(37);

var _ProductOptions2 = _interopRequireDefault(_ProductOptions);

var _OrderItem = __webpack_require__(52);
...
var item = function item(props) {
    var awsLink = "https://s3-ap-southeast-2.amazonaws.com/orders-southeast/";
    ...
    var productList = products.map(function (item) {
        ...
        if (item.image !== null) {
            var src = awsLink + item.image.name;
    ...
    return _react2.default.createElement(
        "div",
        { key: agency.title, className: "orders-wrapper" },
        _react2.default.createElement(
            "h2",
            null,
            agency.title,
...
var ModalStatus = function (_React$Component) {
    ...
    _createClass(ModalStatus, [{
        ...
        value: function submitForm(e) {
            ...
            var productId = form.elements.namedItem("product[id]").value;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./OrderItem.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./OrderItem.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
